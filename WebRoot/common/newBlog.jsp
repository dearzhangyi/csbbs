...
<div class="blog">
	...
	<div class="main">
		<form action="/csbbs/blog/newblog" method="post"> 
		<div>
   			<div align="center">
   			<input type="text" class="textbox" id="topic" name="topic">
   			<br/>
			<textarea id="editor" style="width:960px;height:400px">From csbbs</textarea>
    		<br/>
    		
    		<input type="hidden" id="introduction" name="introduction">
    		<input type="hidden" id="mean" name="content">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
    	...
    	if(hasContent())
	    	{
	    	 $("#mean").val(UE.getEditor('editor').getContent());  
	    	 getPlainTxt();
		    	if(!hasTopic())
		    	{
		    	 alert("您的主题还没写呢");
    ...
    function getPlainTxt() {
        $("#introduction").val(UE.getEditor('editor').getPlainTxt());
    }
	...
	function hasContent() {
		...
		<div class="rsidebar span_1_of_3">
               ...
               <div class="email_box">
					<form action="/csbbs/blog/newBlog">
					  	 <div class="button">
