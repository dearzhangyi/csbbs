		...
		<h2>登录我的BBS</h2>
			<div class="contact-form">
				<div class="para-contact">
					<h4>如果您还没有账户：</h4>
					<p>请点击此链接进入注册页面: <a href="/csbbs/regist" target="_self" title="注册">点击注册新账户</a></p>
		 		  ...
		 		  <div class="get-intouch-left-address">
					...
					<div class="clear"> </div>	
						...
						<div class="form">
				  			<form method="post" action="/csbbs/user/login">
							    	...
							    	<input type="text" class="textbox" name="userpassword" value = "<c:if test="${form.userpassword eq null}">密码</c:if>${form.userpassword}" onFocus="if (this.value == '密码') {this.value = '';}" onBlur="if (this.value == '') {this.value = '密码';}">
										<div class="clear"> </div>
